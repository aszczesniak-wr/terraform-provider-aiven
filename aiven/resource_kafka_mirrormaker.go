...
var aivenKafkaMirrormakerSchema = map[string]*schema.Schema{
	"project": {
...
func resourceKafkaMirrormaker() *schema.Resource {
	return &schema.Resource{
		Create: resourceKafkaMirrormakerCreate,
...
func resourceKafkaMirrormakerCreate(d *schema.ResourceData, m interface{}) error {
	if err := d.Set("service_type", ServiceTypeKafkaMirrormaker); err != nil {
		return err
	}
